            ...
            <div class="grid gap-3 px-6 py-4 border-b border-gray-200 md:flex md:justify-between md:items-center">
              ...
              <div>
                <div class="inline-flex gap-x-2">
                  ...
                  <a class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-lg gap-x-2 hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="{{route('create-doctor')}}">
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="divide-y divide-gray-200">
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="flex items-center px-6 py-2 gap-x-3">
                      ...
                      <a class="flex items-center gap-x-2" href="#">
                        ...
                        <span class="text-sm text-blue-600 decoration-2 hover:underline">China</span>
                      </a>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm font-semibold text-gray-800">195</span>
                      <span class="text-xs text-gray-500">(23.16%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">172</span>
                      <span class="text-xs text-gray-500">(24.50%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">208</span>
                      <span class="text-xs text-gray-500">(21.67%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">68.75%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">1.45%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">00:00:16</span>
                    </div>
                  </td>
                </tr>
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="flex items-center px-6 py-2 gap-x-3">
                      ...
                      <a class="flex items-center gap-x-2" href="#">
                        ...
                        <span class="text-sm text-blue-600 decoration-2 hover:underline">India</span>
                      </a>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm font-semibold text-gray-800">99</span>
                      <span class="text-xs text-gray-500">(11.76%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">80</span>
                      <span class="text-xs text-gray-500">(11.40%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">111</span>
                      <span class="text-xs text-gray-500">(11.56%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">45.05%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">2.50%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">00:01:39</span>
                    </div>
                  </td>
                </tr>
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="flex items-center px-6 py-2 gap-x-3">
                      ...
                      <a class="flex items-center gap-x-2" href="#">
                        ...
                        <span class="text-sm text-blue-600 decoration-2 hover:underline">United States</span>
                      </a>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm font-semibold text-gray-800">96</span>
                      <span class="text-xs text-gray-500">(11.40%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">82</span>
                      <span class="text-xs text-gray-500">(11.68%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">108</span>
                      <span class="text-xs text-gray-500">(11.25%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">61.11%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">2.05%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">00:00:39</span>
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="flex items-center px-6 py-2 gap-x-3">
                      ...
                      <a class="flex items-center gap-x-2" href="#">
                        ...
                        <span class="text-sm text-blue-600 decoration-2 hover:underline">Turkey</span>
                      </a>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">28</span>
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">34.21%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">3.37%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">00:02:51</span>
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="flex items-center px-6 py-2 gap-x-3">
                      ...
                      <a class="flex items-center gap-x-2" href="#">
                        ...
                        <span class="text-sm text-blue-600 decoration-2 hover:underline">Germany</span>
                      </a>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">22</span>
                      <span class="text-xs text-gray-500">(3.13%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">31</span>
                      <span class="text-xs text-gray-500">(3.23%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">64.52%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">1.58%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">00:00:05</span>
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="flex items-center px-6 py-2 gap-x-3">
                      ...
                      <a class="flex items-center gap-x-2" href="#">
                        ...
                        <span class="text-sm text-blue-600 decoration-2 hover:underline">Canada</span>
                      </a>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm font-semibold text-gray-800">24</span>
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">26</span>
                      <span class="text-xs text-gray-500">(2.71%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">50.00%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">2.73%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">00:01:00</span>
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="flex items-center px-6 py-2 gap-x-3">
                      ...
                      <a class="flex items-center gap-x-2" href="#">
                        ...
                        <span class="text-sm text-blue-600 decoration-2 hover:underline">France</span>
                      </a>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">19</span>
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">44.90%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">2.29%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">00:01:32</span>
                    </div>
                  </td>
                </tr>
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="flex items-center px-6 py-2 gap-x-3">
                      ...
                      <a class="flex items-center gap-x-2" href="#">
                        ...
                        <span class="text-sm text-blue-600 decoration-2 hover:underline">Brazil</span>
                      </a>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm font-semibold text-gray-800">42</span>
                      <span class="text-xs text-gray-500">(2.54%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">16</span>
                      <span class="text-xs text-gray-500">(1.54%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">15</span>
                      <span class="text-xs text-gray-500">(1.56%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">39.34%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">1.79%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">00:00:58</span>
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="flex items-center px-6 py-2 gap-x-3">
                      ...
                      <a class="flex items-center gap-x-2" href="#">
                        ...
                        <span class="text-sm text-blue-600 decoration-2 hover:underline">United Kingdom</span>
                      </a>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                  ...
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">14</span>
                      <span class="text-xs text-gray-500">(1.30%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">11</span>
                      <span class="text-xs text-gray-500">(1.22%)</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
                      <span class="text-sm text-gray-800">38.88%</span>
                    </div>
                  </td>
                  <td class="w-auto h-px whitespace-nowrap">
                    <div class="px-6 py-2">
