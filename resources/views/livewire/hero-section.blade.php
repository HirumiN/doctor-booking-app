...
<div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid gap-4 md:grid-cols-2 md:gap-8 xl:gap-20 md:items-center">
      ...
      <div class="relative py-12 ms-4">
        <img class="w-full rounded-md" src="{{asset('doc.jpg')}}" alt="Hero Image">
        <div class="absolute inset-0 -z-[1] bg-gradient-to-tr via-white/0 to-white/0 size-full rounded-md mt-4 -mb-4 me-4 -ms-4 lg:mt-6 lg:-mb-6 lg:me-6 lg:-ms-6"></div>
