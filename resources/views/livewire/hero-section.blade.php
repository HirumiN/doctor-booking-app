...
<div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid gap-4 md:grid-cols-2 md:gap-8 xl:gap-20 md:items-center">
        <div>
            ...
            <p class="mt-3 text-lg text-gray-800">Hand-picked professionals and
                expertly crafted components, designed for any kind of entrepreneur.</p>
            ...
            <div class="grid grid-cols-2 mt-6 lg:mt-10 gap-x-5">
                ...
                <div class="py-5">
                    <div class="flex gap-x-1">
                        <svg class="text-gray-800 size-4" width="51"
                ...
                <div class="py-5">
                    ...
                    <div class="mt-5">
                        <!-- Star -->
                        <svg class="w-16 h-auto text-gray-800 dark:text-white" width="110"
