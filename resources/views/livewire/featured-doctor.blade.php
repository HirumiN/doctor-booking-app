...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="max-w-2xl mx-auto mb-10 text-center lg:mb-14">
        <h2 class="text-2xl font-bold md:text-4xl md:leading-tight">Our Featured Doctor</h2>
        <p class="mt-1 text-gray-600">Specialist</p>
    </div>
    <!-- End Title -->

    <!-- Grid -->
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div class="flex flex-col p-4 bg-white border border-gray-200 rounded-xl md:p-6">
            ...
            <div class="flex items-center mt-3 space-x-1">
                <a class="inline-flex items-center justify-center px-3 py-2 text-sm font-semibold text-gray-500 border border-gray-200 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none"
                    href="#">
        ...
        <div class="flex flex-col p-4 bg-white border border-gray-200 rounded-xl md:p-6">
            ...
            <div class="mt-3 space-x-1">
                <a class="inline-flex items-center justify-center text-sm font-semibold text-gray-500 border border-gray-200 rounded-lg size-8 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none"
                    href="#">
                    <svg class="shrink-0 size-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        fill="currentColor" viewBox="0 0 16 16">
                        <path
        ...
        <a class="flex flex-col justify-center p-4 text-center border border-gray-200 border-dashed col-span-full lg:col-span-1 group rounded-xl md:p-6 hover:shadow-sm focus:outline-none focus:shadow-sm"
            href="#">
            ...
            <div>
                <span
                    class="inline-flex items-center text-blue-600 gap-x-2 group-hover:text-blue-700 group-focus:text-blue-700">
                    See all our doctors
